  ...
  async capabilities() {
    ...
    return {
      ...
      tools: {
        ...
        missions: ['create','list','get','start','next','approve','verify','block','resume','cancel','summary'],
